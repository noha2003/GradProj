...
class _FormScreenState extends State<FormScreen> {
  ...
  final List<String> _constituencies = [
    "العاصمة - الدائرة الانتخابية الأولى",
    "العاصمة - الدائرة الانتخابية الثانية",
    "العاصمة - الدائرة الانتخابية الثالثة",
    "العاصمة - الدائرة الانتخابية الرابعة",
    "العاصمة - الدائرة الانتخابية الخامسة",
    "البادية الشمالية",
    "البادية الوسطى",
    "البادية الجنوبية",
    'الزرقاء',
    "إربد - الدائرة الانتخابية الأولى",
    "إربد - الدائرة الانتخابية الثانية",
    "إربد - الدائرة الانتخابية الثالثة",
    "إربد - الدائرة الانتخابية الرابعة",
    "الزرقاء - الدائرة الانتخابية الأولى",
    "الزرقاء - الدائرة الانتخابية الثانية",
    "البلقاء",
    "الكرك",
    "الطفيلة",
    "جرش",
